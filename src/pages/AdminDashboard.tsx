...
const AdminDashboard = () => {
    ...
    // Function to render bar chart for nominations by type
    ...
    // Function to render bar chart for nominations by year
