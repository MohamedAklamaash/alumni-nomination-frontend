...
const Profile = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      profileBody.rollNo = profileBody.rollNo.trim() || "N/A"; 
      profileBody.linkedInProfile = profileBody.linkedInProfile ? profileBody.linkedInProfile.trim() : "N/A"
      ...
      <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-3 px-5 py-2.5 rounded-full bg-[#333A5c]">
            <input
              type="url"
              placeholder="Social Media Profile URL (Optinonal)"
              className="bg-transparent outline-none w-full text-white"
